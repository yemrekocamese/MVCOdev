...
namespace MVCHomework.Controllers
{
    public class UserRolesController : Controller
    {
        ...
        public UserRolesController(Context context)
        {
            _context = context;
        }
        ...
        {
            var context = _context.UserRoles.Include(u => u.Role).Include(u => u.User);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Context.UserRoles'  is null.");
            }
            var userRole = await _context.UserRoles.FindAsync(id);
            if (userRole != null)
            {
